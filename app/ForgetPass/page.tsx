 ...
 <Head>
      ...
      />
       <div className="bg-opacity-75 p-8 bg-blue-300 rounded-lg shadow-lg max-w-md w-full">
         ...
         <div className="top-4 left-4"> <a href="/LogIn" className="text-indigo-600 hover:underline flex items-center"> <span className="mr-2">←</span> </a> </div>
         ...
         <form onSubmit={handleSubmit}>
           ...
           >
            <a href="/LogIn" className="text-white hover:underline flex items-center justify-center">
             <span className="mr-2"></span><b>Submit</b>
           </a>
         ...
         <div className="mt-4 text-center">
           <a href="/LogIn" className="text-indigo-600 hover:underline flex items-center justify-center">
             <span className="mr-2"></span><b> Back To LogIn</b>
           </a>
         </div>
       </div>
     </div>
